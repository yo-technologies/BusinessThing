...
> Проект находится на стадии архитектурного оформления / Proof of Concept. Директории сервисов пока пусты — ниже описана целевая функциональность и взаимодействие компонент.
