...
var (
	...
	// ErrGenerationStopped indicates the flow was stopped by user
	ErrGenerationStopped = errors.New("generation stopped by user")
)
...
// NewQuotaExceededError создает ошибку превышения квоты
...
// IsQuotaExceededError проверяет, является ли ошибка превышением квоты
